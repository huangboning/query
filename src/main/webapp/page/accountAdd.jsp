...
<body>
	...
	<div id="div_center">
		<div
			...
			<div style="padding-top: 5px; padding-left: 5px;">新增用户</div>
		</div>
		<form id="form1" name="form1" method="post"
			action="<%=path%>/user/addAccount">
			<table id="login_table">
				...
				<tr>
					<td>用户账号：</td>
					<td><input value="" type="text" name="insertAccount.accountName"
				...
				<tr>
					<td>用户密码：</td>
					<td><input value="" type="password" name="insertAccount.accountPassword"
						id="insertAccount.accountPassword" class="input_on" /></td>
				</tr>
				<tr>
					<td>确认密码：</td>
					<td><input value="" type="password" name="insertAccount.confirmPassword"
						id="insertAccount.confirmPassword" class="input_on" /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				...
				<tr>
					<td><input type="submit" value="确认" class="common_btn" /></td>
