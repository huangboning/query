...
public class SceneService {
	...
	public String createScene(String bodyString, Account currentAccount) {
		...
		if (parmJb != null) {
			...
			insertScene.setSceneNo(StringUtil.createSceneNo());
	...
	public String getSceneList(String bodyString, Account currentAccount) {
		...
		for (int i = 0; i < sceneList.size(); i++) {
			...
			dataObj.put("id", scene.getSceneNo());
	...
	public String getSceneVersion(String bodyString, Account currentAccount) {
		...
		sceneObject.put("version", "af975235a63239f9c1b396fe32203bfae6b6de12");
	...
	public String updateScene(String bodyString, Account currentAccount, Map<String, Object> session) {
		...
		if (parmJb != null) {
			String sceneNo = parmJb.optString("sceneNo", "");
			String sceneComment = parmJb.optString("comment", "");
