...
public class JAVARSAEncrypt {
	 ...
	 * 保存在服务端的私钥
	 */
	public static final String LOCAL_PRIVATE_KEY = "rsa_private_key.txt";
	/**
	 * 当前保存在服务端的私钥字节（只初始化一次，减少服务端内存开销）
	 */
	public static byte[] LOCAL_PRIVATE_KEY_DATA = null;
	...
	public static byte[] getPrivateKey() {
		if (LOCAL_PRIVATE_KEY_DATA == null) {
			try {
				...
				in.close();
				LOCAL_PRIVATE_KEY_DATA = out.toByteArray();
			} catch (Exception e) {
				e.printStackTrace();
			}
		}

		return LOCAL_PRIVATE_KEY_DATA;
	}
