...
public class DES3 {
	...
	/**
	 * * 3DES加密 ** @param plainText 普通文本 *
	 * 
	 * @return * @throws Exception
	 * 
	 **/
	public static String encode(byte[] plainByte, String key) throws Exception {
		Key deskey = null;
	...
	public static class Base64 {
		...
		/**
		 * * Decodes the given Base64 encoded String to a new byte array. The
		 * byte array holding the decoded data is returned.
		 */
